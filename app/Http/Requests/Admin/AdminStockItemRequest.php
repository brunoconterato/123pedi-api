...
namespace Drinking\Http\Requests\Admin;

use Illuminate\Foundation\Http\FormRequest;

class AdminStockItemRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'min_selling_price'=>'required|numeric|min:0.01',
    ...
    public function messages()
    {
        return [
            ...
            'min_selling_price.required' => 'Favor inserir um preço mínimo de venda válido',
